...
class RecipeView extends View {
  ...
  addHandlerRender(helper) {
    ['hashchange', 'load'].forEach(ev => window.addEventListener(ev, helper));
  }
        ...
        <div class="recipe__details">
            ...
            <div class="recipe__info">
                ...
                <div class="recipe__info-buttons">
                    <button class="btn--tiny btn--decrease-servings" data-updated-servings = "${
                    ...
                    <button class="btn--tiny btn--increase-servings" data-updated-servings = "${
                      this._data.servings + 1
                    }">
                        <svg>
